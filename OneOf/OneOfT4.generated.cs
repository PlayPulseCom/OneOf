...
namespace OneOf
{
    public struct OneOf<T0, T1, T2, T3, T4> : IOneOf
    {
        ...
        public async Task<OneOf<TResult, T1, T2, T3, T4>> MapT0Async<TResult>(Func<T0, Task<TResult>> mapFunc)
        {
            if (mapFunc == null)
            {
                throw new ArgumentNullException(nameof(mapFunc));
        ...
        public async Task<OneOf<T0, TResult, T2, T3, T4>> MapT1Async<TResult>(Func<T1, Task<TResult>> mapFunc)
        {
            if (mapFunc == null)
            {
                throw new ArgumentNullException(nameof(mapFunc));
        ...
        public async Task<OneOf<T0, T1, TResult, T3, T4>> MapT2Async<TResult>(Func<T2, Task<TResult>> mapFunc)
        {
            if (mapFunc == null)
            {
                throw new ArgumentNullException(nameof(mapFunc));
        ...
        public async Task<OneOf<T0, T1, T2, TResult, T4>> MapT3Async<TResult>(Func<T3, Task<TResult>> mapFunc)
        {
            if (mapFunc == null)
            {
                throw new ArgumentNullException(nameof(mapFunc));
        ...
        public async Task<OneOf<T0, T1, T2, T3, TResult>> MapT4Async<TResult>(Func<T4, Task<TResult>> mapFunc)
        {
            if (mapFunc == null)
            {
                throw new ArgumentNullException(nameof(mapFunc));
        ...
        {
            return o.Match<OneOf<T0, T1, T2, T3, T4>>(
                t0 => t0
            );
        }
        ...
        public static implicit operator OneOf<T0, T1, T2, T3, T4>(OneOf<T1> o)
        {
            return o.Match<OneOf<T0, T1, T2, T3, T4>>(
                t1 => t1
            );
        ...
        public static implicit operator OneOf<T0, T1, T2, T3, T4>(OneOf<T2> o)
        {
            return o.Match<OneOf<T0, T1, T2, T3, T4>>(
                t2 => t2
            );
        ...
        public static implicit operator OneOf<T0, T1, T2, T3, T4>(OneOf<T0, T2> o)
        {
            return o.Match<OneOf<T0, T1, T2, T3, T4>>(
                t0 => t0,
                t2 => t2
        ...
        public static implicit operator OneOf<T0, T1, T2, T3, T4>(OneOf<T1, T2> o)
        {
            return o.Match<OneOf<T0, T1, T2, T3, T4>>(
                t1 => t1,
                t2 => t2
        ...
        public static implicit operator OneOf<T0, T1, T2, T3, T4>(OneOf<T3> o)
        {
            return o.Match<OneOf<T0, T1, T2, T3, T4>>(
                t3 => t3
            );
        ...
        public static implicit operator OneOf<T0, T1, T2, T3, T4>(OneOf<T0, T3> o)
        {
            return o.Match<OneOf<T0, T1, T2, T3, T4>>(
                t0 => t0,
                t3 => t3
        ...
        public static implicit operator OneOf<T0, T1, T2, T3, T4>(OneOf<T1, T3> o)
        {
            return o.Match<OneOf<T0, T1, T2, T3, T4>>(
                t1 => t1,
                t3 => t3
        ...
        public static implicit operator OneOf<T0, T1, T2, T3, T4>(OneOf<T0, T1, T3> o)
        {
            return o.Match<OneOf<T0, T1, T2, T3, T4>>(
                t0 => t0,
                t1 => t1,
        ...
        public static implicit operator OneOf<T0, T1, T2, T3, T4>(OneOf<T2, T3> o)
        {
            return o.Match<OneOf<T0, T1, T2, T3, T4>>(
                t2 => t2,
                t3 => t3
        ...
        public static implicit operator OneOf<T0, T1, T2, T3, T4>(OneOf<T0, T2, T3> o)
        {
            return o.Match<OneOf<T0, T1, T2, T3, T4>>(
                t0 => t0,
                t2 => t2,
        ...
        public static implicit operator OneOf<T0, T1, T2, T3, T4>(OneOf<T1, T2, T3> o)
        {
            return o.Match<OneOf<T0, T1, T2, T3, T4>>(
                t1 => t1,
                t2 => t2,
        ...
        public static implicit operator OneOf<T0, T1, T2, T3, T4>(OneOf<T4> o)
        {
            return o.Match<OneOf<T0, T1, T2, T3, T4>>(
                t4 => t4
            );
        ...
        public static implicit operator OneOf<T0, T1, T2, T3, T4>(OneOf<T0, T4> o)
        {
            return o.Match<OneOf<T0, T1, T2, T3, T4>>(
                t0 => t0,
                t4 => t4
        ...
        public static implicit operator OneOf<T0, T1, T2, T3, T4>(OneOf<T1, T4> o)
        {
            return o.Match<OneOf<T0, T1, T2, T3, T4>>(
                t1 => t1,
                t4 => t4
        ...
        public static implicit operator OneOf<T0, T1, T2, T3, T4>(OneOf<T0, T1, T4> o)
        {
            return o.Match<OneOf<T0, T1, T2, T3, T4>>(
                t0 => t0,
                t1 => t1,
        ...
        public static implicit operator OneOf<T0, T1, T2, T3, T4>(OneOf<T2, T4> o)
        {
            return o.Match<OneOf<T0, T1, T2, T3, T4>>(
                t2 => t2,
                t4 => t4
        ...
        public static implicit operator OneOf<T0, T1, T2, T3, T4>(OneOf<T0, T2, T4> o)
        {
            return o.Match<OneOf<T0, T1, T2, T3, T4>>(
                t0 => t0,
                t2 => t2,
        ...
        public static implicit operator OneOf<T0, T1, T2, T3, T4>(OneOf<T1, T2, T4> o)
        {
            return o.Match<OneOf<T0, T1, T2, T3, T4>>(
                t1 => t1,
                t2 => t2,
        ...
        public static implicit operator OneOf<T0, T1, T2, T3, T4>(OneOf<T0, T1, T2, T4> o)
        {
            return o.Match<OneOf<T0, T1, T2, T3, T4>>(
                t0 => t0,
                t1 => t1,
        ...
        public static implicit operator OneOf<T0, T1, T2, T3, T4>(OneOf<T3, T4> o)
        {
            return o.Match<OneOf<T0, T1, T2, T3, T4>>(
                t3 => t3,
                t4 => t4
        ...
        public static implicit operator OneOf<T0, T1, T2, T3, T4>(OneOf<T0, T3, T4> o)
        {
            return o.Match<OneOf<T0, T1, T2, T3, T4>>(
                t0 => t0,
                t3 => t3,
        ...
        public static implicit operator OneOf<T0, T1, T2, T3, T4>(OneOf<T1, T3, T4> o)
        {
            return o.Match<OneOf<T0, T1, T2, T3, T4>>(
                t1 => t1,
                t3 => t3,
        ...
        public static implicit operator OneOf<T0, T1, T2, T3, T4>(OneOf<T0, T1, T3, T4> o)
        {
            return o.Match<OneOf<T0, T1, T2, T3, T4>>(
                t0 => t0,
                t1 => t1,
        ...
        public static implicit operator OneOf<T0, T1, T2, T3, T4>(OneOf<T2, T3, T4> o)
        {
            return o.Match<OneOf<T0, T1, T2, T3, T4>>(
                t2 => t2,
                t3 => t3,
        ...
        public static implicit operator OneOf<T0, T1, T2, T3, T4>(OneOf<T0, T2, T3, T4> o)
        {
            return o.Match<OneOf<T0, T1, T2, T3, T4>>(
                t0 => t0,
                t2 => t2,
        ...
        public static implicit operator OneOf<T0, T1, T2, T3, T4>(OneOf<T1, T2, T3, T4> o)
        {
            return o.Match<OneOf<T0, T1, T2, T3, T4>>(
                t1 => t1,
                t2 => t2,
